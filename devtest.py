...
standard_strategies = [ [all_cell_insertions], [all_maximum_point_placements, all_symmetric_tilings], [subclass_inferral, row_and_column_separation], [reversibly_deletable_cells, components], [subset_verified, is_empty] ]
