...
from comb_spec_searcher.rule_db.forest import ForestRuleDB, Function, RuleBucket
...
def test_132_universe_pumping():
    ...
    """
    ruledb = ForestRuleDB()
    ruledb.add_rule((0, (1, 2)), (0, 0), RuleBucket.NORMAL)  # Point insertion
    ruledb.add_rule((1, tuple()), tuple(), RuleBucket.VERIFICATION)  # Empty verif
    ruledb.add_rule((2, (3,)), (0,), RuleBucket.NORMAL)  # point placement
    ruledb.add_rule((3, (4,)), (0,), RuleBucket.NORMAL)  # row col sep
    ruledb.add_rule((4, (5, 0, 0)), (0, 1, 1), RuleBucket.NORMAL)  # factor
    ruledb.add_rule((5, tuple()), tuple(), RuleBucket.VERIFICATION)  # point verif
    ruledb.add_rule((2, (6,)), (2,), RuleBucket.UNDEFINED)  # dumb rule
...
def test_132_universe_pumping_progressive():
    ...
    ruledb.add_rule((2, (7,)), (2,), RuleBucket.UNDEFINED)  # dumb rule
...
def test_segmented():
    ...
    ruledb = ForestRuleDB()
    ruledb.add_rule((0, (1, 2)), (0, 0), RuleBucket.UNDEFINED)
    ruledb.add_rule((1, (4, 14)), (0, 0), RuleBucket.UNDEFINED)
    ruledb.add_rule((2, tuple()), tuple(), RuleBucket.UNDEFINED)
    assert ruledb.function == {2: None}

    ruledb.add_rule((3, (16, 5)), (1, 0), RuleBucket.UNDEFINED)
    ruledb.add_rule((4, tuple()), tuple(), RuleBucket.UNDEFINED)
    ruledb.add_rule((5, tuple()), tuple(), RuleBucket.UNDEFINED)
    assert ruledb.function == {2: None, 3: 1, 4: None, 5: None}

    # Induced a gap size change
    ruledb.add_rule((6, (7, 5, 17)), (2, 1, 1), RuleBucket.UNDEFINED)
    assert ruledb.function == {2: None, 3: 1, 4: None, 5: None, 6: 1}

    ruledb.add_rule((16, (6,)), (0,), RuleBucket.UNDEFINED)
    assert ruledb.function == {2: None, 3: 2, 4: None, 5: None, 6: 1, 16: 1}

    ruledb.add_rule((7, tuple()), tuple(), RuleBucket.UNDEFINED)
    ruledb.add_rule((8, (9, 5)), (1, 0), RuleBucket.UNDEFINED)
    assert ruledb.function == {
        2: None,
        3: 2,
        4: None,
    ...
    ruledb.add_rule((12, (20, 5)), (-1, 0), RuleBucket.UNDEFINED)
    ruledb.add_rule((20, (13,)), (0,), RuleBucket.UNDEFINED)
    ruledb.add_rule((13, (15, 2, 5)), (-1, 1, 0), RuleBucket.UNDEFINED)
    ruledb.add_rule((15, (1,)), (0,), RuleBucket.UNDEFINED)
    ruledb.add_rule((14, (3,)), (0,), RuleBucket.UNDEFINED)
    assert ruledb.function == {
        0: 2,
        1: 2,
        2: None,
    ...
    ruledb.add_rule((18, (8,)), (0,), RuleBucket.UNDEFINED)
    ruledb.add_rule((11, (12, 18)), (0, 0), RuleBucket.UNDEFINED)
    assert ruledb.function == {
        0: 2,
        1: 2,
        2: None,
    ...
    ruledb.add_rule((17, (8,)), (0,), RuleBucket.UNDEFINED)
    assert ruledb.function == {
        0: 3,
        1: 3,
        2: None,
    ...
    ruledb.add_rule((9, (0, 19)), (0, 0), RuleBucket.UNDEFINED)
    ruledb.add_rule((10, (5, 11)), (0, 1), RuleBucket.UNDEFINED)
    assert ruledb.function == {
        0: 3,
        1: 3,
        2: None,
    ...
    ruledb.add_rule((19, (10,)), (0,), RuleBucket.UNDEFINED)
