...
- [x] All the Kuszmaul examples. **These have been removed in the most recent version of the paper.** Most of them have a regular insertion encoding - Struct could do all of those ones, plus one more. Here are the smallest bases:
