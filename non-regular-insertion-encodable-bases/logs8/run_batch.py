...
# filename = 'length8' # the file with bases to be processed
# filename = 'length8afterround1'
# filename = 'length8afterround2'
# filename = 'length8afterround3'
filename = 'length8fixiso'
