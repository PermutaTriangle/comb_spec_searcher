...
# filename = 'length3' # the file with bases to be processed
# filename = 'length3afterround1'
# filename = 'length3afterround2p3'
# filename = 'length3afterround3p3'
# filename = 'length3afterround4p3'
# filename = 'length3afterround5p3'
# filename = 'length3afterround6p3'
# filename = 'length3afterround7p3'
# filename = 'length3afterround8p3'
filename = 'length3afterround9p3'
