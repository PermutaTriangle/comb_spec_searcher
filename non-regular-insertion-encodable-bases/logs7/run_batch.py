...
# filename = 'length7' # the file with bases to be processed
# filename = 'length7afterround1'
# filename = 'length7afterround2'
# filename = 'length7afterround3'
# filename = 'length7afterround4'
filename = 'length7fixiso'
